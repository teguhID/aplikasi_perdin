...
<div class="container py-4">
    ...
    <div class="row mt-5">
        <div class="col-md-12">
            <div class="row my-3">
                <div class="col-md-12 text-center">
                    <p class="title-text">Kenapa Harus Rekan Teknik Service?</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 text-center">
                    <div class="card bg-transparent">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 py-4">
                                    <img src="{{ asset('') }}img/berpengalaman.png" alt="" width="150">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="title-text-card">Berpengalaman</p>
                                    <p>Rekan Teknik Service sudah berpengalaman dalam bidang service sejak tahun 90an, maka dari itu kemampuan nya sudah tidak diragukan lagi</p>
                                </div>
                            </div>
                        </div>
                    </div>
