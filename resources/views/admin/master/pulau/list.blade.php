        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body px-5 py-4">
                    <div class="row pt-3">
                        <div class="col-md-6">
                            <h5>Daftar List Pulau</h5>
                        </div>
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.master.pulau.add_view') }}" class="btn btn-outline-primary w-200px">
                                <small>Tambah Pulau</small>
                            </a>
                        </div>
                    </div>
                    <hr>
                                    ...
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="{{ route('admin.master.pulau.edit_view', ['id_pulau' => $value->id_pulau]) }}" class="btn btn-sm btn-outline-primary w-100px">
                                                            <small>Ubah Pulau</small>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="row mt-1">
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary w-100px" onclick="show_modal_hapus('{{ $value->id_pulau }}', '{{ $value->name }}')">
                                                            <small>Hapus Pulau</small>
                                                        </button>
                                                    </div>
                                                </div>
                                            </td>
...
<script>
    ...
    function show_modal_hapus(id_pulau, name){
        var url = "{{ route('admin.master.pulau.delete', ['id_pulau' => ':id_pulau']) }}";
        url = url.replace(':id_pulau', id_pulau);
