        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body px-5 py-4">
                    ...
                    <form action="{{ route('admin.master.kota.post') }}" method="post" id="form_add" class="p-3" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                                <input name="is_luar_negri" id="" class="form-check-input" type="checkbox" value="1">
                            </div>
                        </div>
