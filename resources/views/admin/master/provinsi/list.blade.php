        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body px-5 py-4">
                    <div class="row pt-3">
                        <div class="col-md-6">
                            <h5>Daftar List Provinsi</h5>
                        </div>
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.master.provinsi.add_view') }}" class="btn btn-outline-primary w-200px">
                                    ...
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="{{ route('admin.master.provinsi.edit_view', ['id_provinsi' => $value->id_provinsi]) }}" class="btn btn-sm btn-outline-primary w-100px">
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary w-100px" onclick="show_modal_hapus('{{ $value->id_provinsi }}', '{{ $value->name }}')">
                                                            <small>Hapus Provinsi</small>
                                                        </button>
                                                    </div>
                                                </div>
                                            </td>
...
<script>
    ...
    function show_modal_hapus(id_provinsi, name){
        var url = "{{ route('admin.master.provinsi.delete', ['id_provinsi' => ':id_provinsi']) }}";
        url = url.replace(':id_provinsi', id_provinsi);
