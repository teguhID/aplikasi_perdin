        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body px-5 py-4">
                    <div class="row pt-3">
                        <div class="col-md-6">
                            <h5>Daftar List Role</h5>
                        </div>
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.master.role.add_view') }}" class="btn btn-outline-primary w-200px">
                                    ...
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="{{ route('admin.master.role.edit_view', ['id_role' => $value->id_role]) }}" class="btn btn-sm btn-outline-primary w-100px">
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary w-100px" onclick="show_modal_hapus('{{ $value->id_role }}', '{{ $value->name }}')">
                                                            <small>Hapus Role</small>
                                                        </button>
                                                    </div>
                                                </div>
                                            </td>
...
<script>
    ...
    function show_modal_hapus(id_role, name){
        var url = "{{ route('admin.master.role.delete', ['id_role' => ':id_role']) }}";
