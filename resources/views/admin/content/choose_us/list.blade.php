                ...
                <div class="card-body px-5 py-4">
                    <div class="row pt-3">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.content.choose_us.add_view') }}" class="btn btn-outline-primary w-200px">
                                <small>Tambah</small>
                            </a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($data as $key => $value)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="row">
                                                    <div class="col">
                                                        <a href="{{ route('admin.content.choose_us.edit_view', ['id_choose_us' => $value->id_choose_us]) }}" class="btn btn-sm btn-outline-primary w-100px">
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-md-12">
                                                        <button type="button" class="btn btn-sm btn-outline-secondary w-100px" onclick="show_modal_hapus('{{ $value->id_choose_us }}', '{{ $value->name }}', '{{ $value->image_path }}')">
...
<script>
    ...
    function show_modal_hapus(id_choose_us, name, image_path){
        var url = "{{ route('admin.content.choose_us.delete', ['id_choose_us' => ':id_choose_us']) }}";
        url = url.replace(':id_choose_us', id_choose_us);

        $('#modal_delete_image').val(image_path)
        $('#text_modal_hapus').html('Apakah anda ingin menghapus choose_us ' + name + ' ?')
