                            ...
                            <div class="col-md-4 text-center">
                                <div class="row">
                                    <div class="col text-end">
                                        <form action="{{ route('admin.content.banner.delete', ['id_banner' => $value->id_banner]) }}" method="post">
                                            @csrf
                                ...
                                <div class="row mt-1">
                                    <img src="{{ asset('') }}img/{{ $value->image_path }}" alt="">
                                </div>
                            </div>
                        @endforeach
...
<div class="modal fade" id="modal_add_banner" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">

            <form action="{{ route('admin.content.banner.post') }}" method="post" id="form_delete" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row my-5">
                        <div class="col-md-12 text-center">
                            ...
                            <img id="image-preview" src="{{ asset('') }}img/no_image.jpg" alt="Image Preview" width="400"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 text-center">
